...
```{r,echo=TRUE}
boxplot(dataset$temp,col="blue",main="boxplot pour la variable temperature")
```
...
```{r,echo=TRUE}
boxplot(dataset$wind,col="blue",main="boxplot pour la variable wind")
```
...
```{r,echo=TRUE}
boxplot(dataset$rain,main="boxplot pour la variable rain")
```
...
```{r,echo=TRUE}
boxplot(dataset$area,main="boxplot pour la variable area")
```
