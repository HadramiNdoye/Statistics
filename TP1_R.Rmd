...
les deux regressions lineaires montrent qu'il y'a une faible dependance entre la temperature et la pluie, puis la temperature avec la vitesse du vent, cela permet de dire que la temperature n'est pas le seul facteur qui impacte la pluie et le vent.  
